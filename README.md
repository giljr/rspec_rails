...
Webpage: [Mastering JSON Responses in Rails API](https://medium.com/jungletronics/mastering-json-responses-in-rails-api-0cd5805d8351)
...
**Brett Codes**
"_Testing a Rails API with Request Specs (Test Driven RSpec, Ep 02)_"

YouTube [video](https://youtu.be/Wb3oIfiLdZU?si=buTBaKhzUy0zvDmm)
